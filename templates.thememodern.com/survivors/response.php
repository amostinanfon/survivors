...
<!-- Mirrored from templates.thememodern.com/amwal/career.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 23 Aug 2023 12:40:08 GMT -->
<head>
    <meta charset="utf-8">
...
<div id="page">
        ...
        <ul>
            ...
            <li>
                ...
                <ul >
                    ...
                    <li >
                        <a  href="testimonials.html">Témoignage</a>
                    </li>
                        ...
                        <div class="topbar-home2">
                            <div class="tb-contact tb-iconbox">
                                <ul>
                                    ...
                                    <li><a href="mailto:contact@associationsurvivors.org"><i class="fa fa-envelope" aria-hidden="true"></i> contact@associationsurvivors.org</a></li>
                                    <li><a href="tel:00237691386635"><i class="fa fa-phone" aria-hidden="true"></i> 00237691386635</a></li>
                                </ul>
                            </div>
                            <div class="tb-social-lan language">
                                <select class="lang">
                                    ...
                                    <option data-class="fr">Français</option>
    ...
    <section class="no-padding sh-career">
        <div class="sub-header ">
            <span>FORMULAIRE ENVOYE AVEC SUCCES</span>
            <h3>PATIENTEZ 48 HEURES </h3>
            <ol class="breadcrumb">
                <li>
                    <a href="#"><i class="fa fa-home"></i> ACCUEIL     </a>
                </li>
                <li>
                    <a href="company_history.html">ASSOCIATION    </a>
                </li>
    ...
    <section class="no-padding">
        <div class="container">
            <div class="row">
                <div class="col-md-8 desk-pdt-100">
                    <div class="title-block title-contact">
                        <h3>Pourquoi un retour dans 48 heures ?</h3>
